namespace Conflux.Graphql
{
	...
	public class GraphTypeConverter : IGraphTypeConverter
	{
		private readonly IAdditionalGraphTypeConverter additionalGraphTypeConverter;

		public GraphTypeConverter(IAdditionalGraphTypeConverter additionalGraphTypeConverter)
		{
			this.additionalGraphTypeConverter = additionalGraphTypeConverter;
		}

		public Type ConvertTypeToGraphType(Type propertyType, RequiredType requiredType = RequiredType.Default, bool isInputType = false)
		{
		...
		private Type BaseGraphType(Type propertyType, bool isInputType = false)
		{
			if (additionalGraphTypeConverter != null)
			{
				var resolvedType = this.additionalGraphTypeConverter.BaseGraphType(propertyType, isInputType, this.ConvertTypeToGraphType);
